...
<form action="<?php echo site_url('admin/update_member/' . $member['id']); ?>" method="post" style="width: 400px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" id="phone" name="phone" value="<?php echo $member['phone']; ?>"
               style="width: 100%; padding: 10px; font-size: 14px; border: 1px solid #ddd; border-radius: 5px;">
    </div>
